...
const ConfigEditor: React.FC<ConfigEditorProps> = ({ initialConfig }) => {
  ...
  useEffect(() => {
    ...
    if (textarea) {
      const handleChange = () => {
        handleJsonTextChange(textarea.value)
      }
  ...
  const renderTextField = (label: string, path: string, multiline = false) => (
    <TextField
      ...
      label={label}
      value={
        path.split(".").reduce((obj: any, key) => obj?.[key], config) || ""
      }
            ...
            <AccordionDetails>
              <Stack spacing={2}>
                  ...
                  <Paper key={index} sx={{ p: 2 }}>
                    <Stack spacing={1}>
                      ...
                      <TextField
                        ...
                        value={city.key}
                        onChange={(e) =>
                          updateConfig(`cities.${index}.key`, e.target.value)
                        }
                        size="small"
                        InputProps={{
                          sx: { color: "text.primary" },
                      ...
                      <TextField
                        ...
                        value={city.label}
                        onChange={(e) =>
                          updateConfig(`cities.${index}.label`, e.target.value)
                        }
                        size="small"
                        InputProps={{
                          sx: { color: "text.primary" },
                      ...
                      <TextField
                        ...
                        value={city.query}
                        onChange={(e) =>
                          updateConfig(`cities.${index}.query`, e.target.value)
                        }
                        size="small"
                        InputProps={{
                          sx: { color: "text.primary" },
                ...
                <Button
                  ...
                  startIcon={<AddIcon />}
                  onClick={() =>
                    addItem("cities", { key: "", label: "", query: "" })
                  }
                >
                  Añadir Ciudad
                </Button>
            ...
            <AccordionDetails>
              <Stack spacing={2}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateConfig("expenses.budget", Number(e.target.value))
                  }
                  size="small"
                />
                      ...
                      <Stack spacing={1}>
                        ...
                        <Stack direction="row" spacing={1}>
                          <TextField
                            ...
                            onChange={(e) =>
                              updateConfig(
                                `expenses.items.${index}.amountEUR`,
      ...
      {tabValue === 1 && (
        <Stack spacing={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            Tip: You can paste a complete JSON configuration here and it will be
