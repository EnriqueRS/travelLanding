    ...
    <ThemeProvider theme={darkTheme}>
      <Box sx={{ color: "text.primary", p: 2, height: 'calc(100vh - 100px)', display: 'flex', flexDirection: 'column' }}>
        ...
        <Box sx={{ display: 'flex', flexGrow: 1, overflow: 'hidden', gap: 0 }}>
          ...
          <Box sx={{ 
            width: `${visualWidth}%`, 
            display: 'flex', flexDirection: 'column', overflowY: 'auto', pr: 2 
          }}>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Stack spacing={2}>
                    ...
                    />
                    <TextField
                        fullWidth label="Fecha de Inicio (ISO)" size="small"
                        value={config.trip?.startISO || ""}
                        onChange={(e) => updateConfigField("trip.startISO", e.target.value)}
                    />
                  </Stack>
                </AccordionDetails>
              </Accordion>
          ...
          <Box sx={{ flexGrow: 1, width: `${100 - visualWidth}%`, display: 'flex', flexDirection: 'column', pl: 2 }}>
            ...
            <Stack direction="row" spacing={2} mt={2}>
              <Button variant="contained" color="secondary" startIcon={<SaveIcon />} onClick={handleSave} fullWidth>
                Guardar Cambios
              </Button>
