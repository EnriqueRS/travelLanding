...
export default function Countdown(props: { targetISO: string; label?: string }): JSX.Element {
	...
	return (
		<div className="grid grid-flow-col auto-cols-max gap-4 items-center text-center">
